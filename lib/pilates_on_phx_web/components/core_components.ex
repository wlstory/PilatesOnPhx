defmodule PilatesOnPhxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PilatesOnPhxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PilatesOnPhxWeb.Gettext, "errors", msg, opts)
    end
  end
