...
config :pilates_on_phx, PilatesOnPhxWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PilatesOnPhxWeb.ErrorHTML, json: PilatesOnPhxWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: PilatesOnPhx.PubSub,
  live_view: [signing_salt: "5kw9kCG4"]
...
config :pilates_on_phx, PilatesOnPhx.Mailer, adapter: Swoosh.Adapters.Local
